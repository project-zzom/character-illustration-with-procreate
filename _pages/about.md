...
![프로필 저자]({{ site.url }}{{ site.baseurl }}/assets/images/profile/profile-author.jpg)<br/>
...
■ 옮긴이: 신상재 (번역하는 개발자)<br/>
![프로필 역자]({{ site.url }}{{ site.baseurl }}/assets/images/profile/profile-translator.jpg)<br/>
...
![프로필 유다혜]({{ site.url }}{{ site.baseurl }}/assets/images/profile/profile-beta-reader (유다혜).jpg)<br/>
...
■ 이아름 (프리랜서 / 개발자)<br/>
![프로필 이아름]({{ site.url }}{{ site.baseurl }}/assets/images/profile/profile-beta-reader (이아름).jpg)<br/>
...
■ 홍수영 (삼성SDS / 개발자)<br/>
![프로필 홍수영]({{ site.url }}{{ site.baseurl }}/assets/images/profile/profile-beta-reader (홍수영).jpg)<br/>
...
![프로필 윤인성]({{ site.url }}{{ site.baseurl }}/assets/images/profile/profile-beta-reader (윤인성).jpg)<br/>
